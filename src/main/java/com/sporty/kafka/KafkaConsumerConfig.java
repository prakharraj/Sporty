...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<Long, SportsEventOutcome> consumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<Long, SportsEventOutcome> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<Long, SportsEventOutcome> factory =
